...
namespace ECommerceApp.DTOs.AddressesDTOs
{
    ...
    public class AddressUpdateDTO
    {
        ...
        [StringLength(100,ErrorMessage ="Address Line 2 can't exceed 100 charactes.")]
        public string AddressLine2 { get; set; }
        [Required(ErrorMessage ="City is required.")]
        [StringLength(50,ErrorMessage ="City cant exceed 50 characters.")]
        ...
        [StringLength(50,ErrorMessage ="Country is required.")]
