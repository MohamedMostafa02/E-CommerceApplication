...
namespace ECommerceApp.Services
{
    public class CustomerService
    {
        ...
        public async Task<ApiResponse<LoginResponseDTO>> LoginAsync(LoginDTO loginDTO)
        {
            ...
            {
               return new ApiResponse<LoginResponseDTO>(500,$"An unexpected error occured while processing your request, Error: {ex.Message}" );
            }
        }
        ...
        // Changes teh passwor for an existing customer.
        public async Task<ApiResponse<ConfirmationResponseDTO>> ChangePasswordAsync(ChangePasswordDTO changePasswordDto)
        {
            try
            {
                ...
                // Prepare confirmation message 
                var confirmatonMessage = new ConfirmationResponseDTO
                {
                    Message = "Password changed successfully."
                };
                return new ApiResponse<ConfirmationResponseDTO>( 200, confirmatonMessage);
            }
            catch (Exception ex)
            {
                return new ApiResponse<ConfirmationResponseDTO>(500, $"An unexpected error occurred while processing your request, Error: {ex.Message}");
