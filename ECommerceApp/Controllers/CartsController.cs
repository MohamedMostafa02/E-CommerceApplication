...
namespace ECommerceApp.Controllers
{
    ...
    public class CartsController : ControllerBase
    {
        ...
        // Retrieves the active cart of a given customer
        ...
        public async Task<ActionResult<ApiResponse<CartResponseDTO>>> RemoveCartItem([FromBody] UpdateCartItemDTO updateCartItemDTO)
        {
